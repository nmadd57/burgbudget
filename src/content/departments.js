 ...
 *
 * "mayoralDiscretion: true" marks departments the Mayor actually appoints
 * the head of (or runs directly, for the Mayor's own office) - verified
 * against Fitchburg's charter and city website, not assumed. It's left off
 * departments controlled by a separate elected body (City Council, the
 * School Committee), set by an outside formula or contract (debt service,
 * the Monty Tech assessment, employee benefits), or that are just
 * administrative bookkeeping (transfers, miscellaneous expenses) - the
 * Mayor proposes a number for those too, but doesn't have the same kind of
 * year-to-year discretion over them that they do over a department they
 * appoint the head of.
 */
