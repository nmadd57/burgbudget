...
export const departmentContent = {
  ...
  "finance-administration": {
    ...
    whoRunsIt: "A mix of elected and appointed officials - the City Auditor, Treasurer/Collector, Board of Assessors, and department heads the Mayor appoints, like IT and Human Resources.",
  ...
  "board-of-health": {
    ...
    whoRunsIt: "A Board of Health, either elected or Mayor-appointed depending on the city's practice, along with public health staff.",
  ...
  "human-services": {
    ...
    whoRunsIt: "Several smaller city offices and boards, including the Veterans' Services Officer and the Council on Aging.",
